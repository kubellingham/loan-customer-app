...
export default function OtpPage() {
  ...
  async function handleVerify() {
    ...
    router.push(`/dashboard?phone=${phone}`);
  }
    ...
    <main className="min-h-screen bg-[#020617] flex items-center justify-center px-4 text-white">
      <div className="w-full max-w-sm">
        ...
        <input
          ...
          maxLength={6}
          className="w-full mb-4 px-4 py-3 text-center tracking-widest text-lg rounded-lg bg-[#020617] border border-gray-700"
        />

        {/* ✅ Remember device checkbox */}
        <label className="flex items-center gap-2 mb-6 text-sm text-gray-400">
          <input
            type="checkbox"
